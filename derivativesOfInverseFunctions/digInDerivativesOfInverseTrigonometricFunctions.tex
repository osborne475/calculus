...
\begin{theorem}[The derivative of arctangent]\index{derivative!of arctangent}
  ...
  \]
  \begin{explanation} 
     To start, note that the Inverse Function Theorem assures us that this  %The Inverse Function Theorem hasn't been stated yet since it is the next section... do we want to reference it here?
     derivative actually exists.
    Recall
    \[
    \arctan(x) = \theta
